...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_FONT = Color.parseColor("#00A1E8");
    private static int mTitleFontSize;//title字体大小
    private int mHeaderViewCount = 0;
    private int paddintleft=13;
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        ...
        paddintleft= (int) (context.getResources().getDisplayMetrics().density*paddintleft+1);
    }
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), paddintleft, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
